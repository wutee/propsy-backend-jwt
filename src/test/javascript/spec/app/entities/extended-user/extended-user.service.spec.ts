...
describe('Service Tests', () => {
    describe('ExtendedUser Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ExtendedUser(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ExtendedUser', async () => {
            ...
            it('should update a ExtendedUser', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        address: 'BBBBBB',
            ...
            it('should return a list of ExtendedUser', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        address: 'BBBBBB',
            ...
            it('should delete a ExtendedUser', async () => {
